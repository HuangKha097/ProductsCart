...
import styles from "../src/css/Product.module.scss";
        ...
        <div className={cx("product-wrapper")}>
            <div className={cx("product-image")}>
                <img
                    src={image}
                    alt={name}
                    className={countProduct > 0 && cx("active")}
                />
                {!cart.find((item) => item.name.includes(name)) ? (
                    ...
                    <div className={cx("add-to-cart-btn-count")}>
                        <button
                            className={cx("minus")}
            ...
            <div className={cx("product-info")}>
                <p className={cx("product-category")}>{category}</p>
